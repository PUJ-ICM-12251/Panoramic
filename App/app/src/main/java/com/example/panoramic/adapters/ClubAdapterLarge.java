...
public class ClubAdapterLarge extends RecyclerView.Adapter<ClubAdapterLarge.ViewHolder> {

    ArrayList<NightClub> nightClubs;

    ClubAdapterBinding binding;

    public ClubAdapterLarge(ArrayList<NightClub> nightClubs){
        this.nightClubs=nightClubs;
    }

    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate= LayoutInflater.from(parent.getContext()).inflate(R.layout.club_adapterlarge,parent,false);
